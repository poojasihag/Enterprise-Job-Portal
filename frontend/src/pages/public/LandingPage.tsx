    ...
    return (
      <>
        <div className="bg-[#7b98de] flex justify-between items-center h-10 w-8xl text-white">
          <h1 className="text-2xl">Enterprise-Job-Portal</h1>
          <button className="bg-[#091a42]  border-none text-white px-2  py-1 rounded align-center text-decoration-none inline-block font-bold cursor-pointer">
            Sign In
          </button>
        </div>
